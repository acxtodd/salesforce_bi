...
export default class AscendixAiSearch extends NavigationMixin(LightningElement) {
    ...
    lastExchange = null;          // {query: string, answer: string}
    _pendingPriorContext = null;  // captured before handleSubmit() resets state
    ...
    async callAnswerEndpoint(requestBody) {
        try {
            ...
            if (response) {
                ...
                // Save exchange for potential clarification context
                this.lastExchange = {
